        ...
        <div className="flex flex-col sm:flex-row justify-center sm:justify-between items-center sm:items-start px-9 text-center sm:text-left ">
          ...
          <div className="w-full sm:w-1/3 flex flex-col items-center sm:items-start order-2 sm:order-1">
            ...
            <p className="mb-1 text-gray-800">
              Arcade Academy is an innovative platform designed to enhance the
              learning experience for students by leveraging Augmented Reality
              (AR) technology. Our mission is to make subjects like history and
              science more engaging, interactive, and easier to understand. By
              bringing educational content to life, Arcade Academy helps
              students visualize complex concepts and immerse themselves in
