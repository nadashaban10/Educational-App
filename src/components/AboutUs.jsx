...
function AboutUs() {
  return (
    <div id='features' className='md:px-14  max-w-screen-lg mx-auto w-full mt-[100px] '>
      ...
      <div className="flex flex-col md:flex-row justify-between items-center gap-4 mt-8">
        ...
        <div className='md:w-1/2 order-1 md:order-2'>
          <img src={imagtwo} alt='image' className='w-[400px] h-auto rounded-lg shadow-lg'/>
        </div>
      </div>
      <div className="flex flex-col md:flex-row justify-between items-center gap-4 mt-8">
        <div className='md:w-1/2 order-1 md:order-1'>
          <img src={imagethree} alt='image' className='w-[400px] h-auto rounded-lg shadow-lg'/>
        </div>
...
.</p>
        ...
        <div className='md:w-1/2 order-1 md:order-2'>
          <img src={imagefour} alt='image' className='w-[400px] h-auto rounded-lg shadow-lg'/>
        </div>
      </div>
    </div>
  );
